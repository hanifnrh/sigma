...
export default function Graph() {
    return (
        <main>
            <div className="flex flex-col lg:flex-row justify-center items-center pt-36 font-mono">
                <ParticlesBackground />
                {/* First Card */}
                <div className="w-full bg-white rounded-lg shadow dark:bg-black p-4 md:p-6 m-5">
                    <div className="flex justify-between">
                        <div>
                            <h5 className="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">20 ppm</h5>
                            <p className="text-base font-normal text-gray-500 dark:text-gray-400">Ammonia Level</p>
                        </div>
                ...
                <AreaChart id="area-chart1"></AreaChart>
                {/* Second Card */}
                <div className="w-full bg-white rounded-lg shadow dark:bg-black p-4 md:p-6 m-5">
                    <div className="flex justify-between">
                        <div>
                ...
                <AreaChart id="area-chart2"></AreaChart>
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center font-mono">
                ...
                <AreaChart id="area-chart3"></AreaChart>
                {/* Second Card */}
                <div className="w-full bg-white rounded-lg shadow dark:bg-black p-4 md:p-6 m-5">
                    <div className="flex justify-between">
                        <div>
                ...
                <AreaChart id="area-chart4"></AreaChart>
