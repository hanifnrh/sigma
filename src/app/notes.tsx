...
const Navbar: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-screen-2xl mx-auto relative">
            <div className="sticky top-0 z-50 w-full bg-white dark:bg-gray-800 transition-colors">
                <button
                ...
                <aside
                    ...
                    className={`hidden 2xl:flex sticky top-0 z-40 w-56 xl:w-64 h-screen bg-white dark:bg-gray-800 transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
                    aria-label="Sidebar"
                >
                    <div className="flex flex-col h-full px-3 py-4 border-r dark:border-gray-700 overflow-y-auto">
                        <Link href="/" className="flex items-center ps-2.5">
                            <Image src="/sigmalogo.png" alt="Logo" width={256} height={256} className="md:h-12 xl:h-16 w-auto" />
                        </Link>
                        {/* Menu Items */}
                        <ul className="space-y-2 font-medium">
                            <p className='body-bold navbar-title text-sm sm:text-xs xl:text-sm mb-2'>
                                MAIN MENU
                            </p>
                            <li>
                                <Link
                ...
                {/* Sidebar for Screens 1536px and Below */}
                <aside
                    id="separator-sidebar-mobile"
                    className={`2xl:hidden fixed top-0 left-0 z-40 w-56 xl:w-64 h-screen bg-white dark:bg-gray-800 border-r dark:border-gray-700 transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
                    aria-label="Sidebar"
                >
