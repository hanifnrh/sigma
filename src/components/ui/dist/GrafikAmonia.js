...
function GrafikAmonia() {
    return (React.createElement("main", { className: "p-6 bg-white dark:bg-zinc-900 border rounded-lg w-full" },
        React.createElement("div", { className: "w-full bg-white rounded-lg dark:bg-zinc-900" },
            React.createElement("div", { className: "flex justify-between" },
                React.createElement("div", null,
                    React.createElement("p", { className: "text-base font-normal text-gray-500 dark:text-gray-400" }, "Amonia"),
                    React.createElement("h5", { className: "leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2" }, "20 ppm")),
        ...
        React.createElement(AreaChart, { id: "area-chart1", color: "#28A745" })));
}
exports["default"] = GrafikAmonia;
