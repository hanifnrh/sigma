...
function GrafikKelembapan() {
    return (React.createElement("main", { className: "p-6 bg-white dark:bg-zinc-900 border rounded-lg w-full" },
        React.createElement("div", { className: "w-full bg-white rounded-lg dark:bg-zinc-900" },
            React.createElement("div", { className: "flex justify-between" },
                React.createElement("div", null,
                    React.createElement("p", { className: "text-base font-normal text-gray-500 dark:text-gray-400" }, "Kelembapan"),
                    React.createElement("h5", { className: "leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2" }, "55%")),
        ...
        React.createElement(AreaChart, { id: "area-chart4", color: "#FF5733" })));
}
exports["default"] = GrafikKelembapan;
