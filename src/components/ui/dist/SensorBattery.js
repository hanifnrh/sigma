...
exports.SensorBattery = void 0;
var react_battery_gauge_1 = require("react-battery-gauge");
function SensorBattery() {
    return (React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-1 gap-4 mt-5" },
...
exports.SensorBattery = SensorBattery;
